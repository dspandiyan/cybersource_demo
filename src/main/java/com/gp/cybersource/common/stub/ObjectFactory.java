 ...
 * generated in the com.gp.cybersource.common.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestMessage_QNAME = new QName("urn:schemas-cybersource-com:transaction-data-1.104", "requestMessage");
    private final static QName _ReplyMessage_QNAME = new QName("urn:schemas-cybersource-com:transaction-data-1.104", "replyMessage");
    private final static QName _NvpRequest_QNAME = new QName("urn:schemas-cybersource-com:transaction-data-1.104", "nvpRequest");
    private final static QName _NvpReply_QNAME = new QName("urn:schemas-cybersource-com:transaction-data-1.104", "nvpReply");
    private final static QName _FaultDetails_QNAME = new QName("urn:schemas-cybersource-com:transaction-data-1.104", "faultDetails");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gp.cybersource.common.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.104", name = "requestMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.104", name = "replyMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.104", name = "nvpRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.104", name = "nvpReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-cybersource-com:transaction-data-1.104", name = "faultDetails")
