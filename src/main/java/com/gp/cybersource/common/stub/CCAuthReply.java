...
/**
 * <p>
 * Java class for CCAuthReply complex type.
 * 
 * <p>
 ...
 *         &lt;element name="authorizedDateTime" type="{urn:schemas-cybersource-com:transaction-data-1.104}dateTime" minOccurs="0"/&gt;
 ...
 *         &lt;element name="fxQuoteRate" type="{urn:schemas-cybersource-com:transaction-data-1.104}dateTime" minOccurs="0"/&gt;
 *         &lt;element name="fxQuoteType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="fxQuoteExpirationDateTime" type="{urn:schemas-cybersource-com:transaction-data-1.104}dateTime" minOccurs="0"/&gt;
 ...
 *         &lt;element name="accountBalance" type="{urn:schemas-cybersource-com:transaction-data-1.104}amount" minOccurs="0"/&gt;
 ...
 *         &lt;element name="requestAmount" type="{urn:schemas-cybersource-com:transaction-data-1.104}amount" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = { "reasonCode", "amount", "authorizationCode", "avsCode", "avsCodeRaw", "cvCode",
		"cvCodeRaw", "personalIDCode", "authorizedDateTime", "processorResponse", "bmlAccountNumber", "authFactorCode",
		"reconciliationID", "fundingTotals", "fxQuoteID", "fxQuoteRate", "fxQuoteType", "fxQuoteExpirationDateTime",
		"authRecord", "merchantAdviceCode", "merchantAdviceCodeRaw", "cavvResponseCode", "cavvResponseCodeRaw",
		"authenticationXID", "authorizationXID", "processorCardType", "accountBalance", "forwardCode",
		"enhancedDataEnabled", "referralResponseNumber", "subResponseCode", "approvedAmount", "creditLine",
		"approvedTerms", "paymentNetworkTransactionID", "cardCategory", "ownerMerchantID", "requestAmount",
		"requestCurrency", "accountBalanceCurrency", "accountBalanceSign", "affluenceIndicator", "evEmail",
